            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="nav-tabs-custom box-body box-profile" style="box-shadow: 2px 2px 1px grey;">
                    <div class="tab-content" style="padding-right: 40px;">
                        <div class="post">
                            ...
                            <h2 style="text-align:center;">Công ty <span style="color: red"><?php echo $extra['basic_company']['company']; ?></span></h2>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-12 textarea-h">
                            <div>
                                <?php
                                echo htmlspecialchars_decode($company['products_solutions_nominated_1']);
                                ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-12 textarea-h">
                            <div>
                                <?php
                                echo htmlspecialchars_decode($company['products_solutions_nominated_2']);
                                ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-12 textarea-h">
                            <div>
                                <?php
                                echo htmlspecialchars_decode($company['products_solutions_nominated_3']);
                                ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-2 pull-left">
                        <a href="<?php echo base_url('admin/company/index/' . $year); ?>" class="btn btn-default btn-block"><b>Quay lại</b></a>
                    </div>
                    <?php if($reg_status['is_final'] == 0): ?>
                        <h4 style="color:red">Doanh nghiệp chưa gửi thông tin</h4>
                    <?php else: ?>
                        <h4 style="color:darkblue">Doanh nghiệp đã gửi thông tin</h4>
                    <?php endif; ?>
                </div>

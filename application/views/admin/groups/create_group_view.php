            ...
            <div class="modified-mode">
                <div class="col-lg-10 col-lg-offset-0" style="margin-left: 15px;">
                    ...
                    <div class="form-group picture">
                        ...
                        echo form_input('group_name', set_value('group_name'), 'class="form-control" id="group_name"');
                        ?>
                    </div>
                    <div class="form-group picture">
                        <?php
                        ...
                        echo form_input('group_description', set_value('group_description'), 'class="form-control" id="group_description"');
                        ?>
                    </div>
                    <br>

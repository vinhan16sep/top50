                        ...
                        <table class="table table-bordered rating-table" style="border: 1px solid black;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($rating){
                                        echo form_input('4_3', set_value('4_3', (isset($arrRate['4_3']) && $arrRate['4_3'] != 0) ? ltrim($arrRate['4_3'], '0') : 0), 'class="form-control sub" id="4_3"');
                                    }else{
...
<script>
    $('.sub').change(function(){
        ...
        let main6 = (parseInt($('#6_1').val()) * 0.2 + parseInt($('#6_2').val()) * 0.4 + parseInt($('#6_3').val()) * 0.4) * 0.1;

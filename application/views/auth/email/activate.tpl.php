...
<body>
	...
	<p>Cảm ơn Quý Công ty đã đăng ký tham gia Chương trình TOP 10 Doanh nghiệp CNTT Việt Nam <?php echo date('Y'); ?>. Quý Công ty đã sử dụng email: <?php echo $email ?> để đăng ký tài khoản tham gia chương trình.</p>

            ...
            <div class="col-lg-10 col-lg-offset-0">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-sx-12">
                            ...
                            $main_service = (array)$this->input->post('main_service');
                            $options = array(
                            ...
                            <div class="text_input">
                                <table class="tables-css table table-bordered" >
                                    <tr>
                                        ...
                                        <td >
                                            <?php
                                                echo form_input('proportion_market_local', set_value('proportion_market_local'), 'class="form-control"');
                                            ?>
                                            %
                                        </td>
                                        ...
                                        <td >
                                            <?php
                                                echo form_input('proportion_market_europe', set_value('proportion_market_europe'), 'class="form-control"');
                                            ?>
                                            %
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td >
                                            <?php
                                                echo form_input('proportion_market_america', set_value('proportion_market_america'), 'class="form-control"');
                                            ?>
                                            %
                                        </td>
                                        ...
                                        <td >
                                            <?php
                                                echo form_input('proportion_market_japan', set_value('proportion_market_japan'), 'class="form-control"');
                                            ?>
                                            %
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td >
                                            <?php
                                                echo form_input('proportion_market_other_international', set_value('proportion_market_other_international'), 'class="form-control"');
                                            ?>
                                            %
                                        </td>
                                        <td colspan="2"></td>
                ...
                <div class="form-group h5 m-l-30">
                    <div class="row">
                        <div class="col-xs-12">
                             <?php
                                echo form_textarea('specific_certificate', htmlspecialchars_decode(set_value('specific_certificate')), 'class="form-control tinymce-area"');
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group h5 m-l-30">
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <?php
                            echo form_textarea('startup_plan_capital_future', htmlspecialchars_decode(set_value('startup_plan_capital_future')), 'class="form-control tinymce-area"');
                            ?>
                        </div>
                    </div>
                </div>
                <div class="form-group h5 m-l-30">
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <?php
                            echo form_textarea('startup_plan_ipo', htmlspecialchars_decode(set_value('startup_plan_ipo')), 'class="form-control tinymce-area"');
                            ?>
                        </div>
                    </div>
                </div>
